...
public class Tag implements Serializable {
	...
	private Integer article_count;//该标签的文章数量
	/**
	* 获取 aid
	* @return  aid aid
	* 由CSMMAACToolv4.2生成
...
/**
	...
	return "Tag [aid=" +aid+",tag_id=\"" +tag_id+"\",name=\"" +name+"\",status=" +status+",create_time=\"" + StrUtil.Timesamp2String(create_time)+"\",update_time=\"" + StrUtil.Timesamp2String(update_time)+"\",can_del=" +can_del+",article_count=" +article_count+""+"]"; 
	} 
}
